...
const Book = ({book}) => {
    return (
        <Link to={`../Book/${book.isbn13}`}>
            ...
            <div className='bg-black px-6 py-4 opacity-0 hover:opacity-100 text-gray-300 bg-opacity-75 absolute inset-0 transition-opacity duration-200 flex flex-col'>
                <p>{book.title}</p>
                <br />
